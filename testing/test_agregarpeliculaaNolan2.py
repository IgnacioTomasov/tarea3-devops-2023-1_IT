...
class TestAgregarpeliculaaNolan2():
  ...
  def test_agregarpeliculaaNolan2(self):
    ...
    self.driver.find_element(By.ID, "title").send_keys("Interstellar2")
    self.driver.find_element(By.ID, "description").click()
    self.driver.find_element(By.ID, "description").send_keys("2027")
